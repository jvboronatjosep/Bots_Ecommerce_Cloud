...
# Inverso: código de provincia → prefijo de CP (para generar CPs válidos por provincia)
PROVINCE_PREFIXES = {code: prefix for prefix, code in PROVINCE_BY_ZIP_PREFIX.items()}

# Nombres comunes de provincia (en minúsculas) → código de provincia
PROVINCE_NAME_TO_CODE = {
    ...
    "avila": "AV",       "ávila": "AV",
    "badajoz": "BA",
    "baleares": "PM",    "illes balears": "PM",  "mallorca": "PM",
    "barcelona": "B",
    "burgos": "BU",
